...
(function($, window, document){
  ...
  var collapseSelector = '[data-toggle="collapse-next"]',
      // FIX Genna: commit 5a1e331c3ba070203b9a95c5fe15bf834d2de9d0
      // definition of colllapsibles has been moved below
  ...
  $(function() {
    ...
    $(document)
      .on('click', collapseSelector, function (e) {
          ...
          // FIX Genna: commit 5a1e331c3ba070203b9a95c5fe15bf834d2de9d0
          // We need to get the list of menu items every time because of dynamic nature of the menu
          // in contrast to the static structure like in the template
          var colllapsibles = $('.sidebar .collapse').collapse({toggle: false});
