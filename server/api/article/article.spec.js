    ...
    it('should be able to handle page query', function(done) {
      request(app)
        ...
        .expect(function(res) {
          ...
          expect(body).to.have.key('page_size');
    ...
    it('should return the added articles', function(done) {
      request(app)
        ...
        .expect(function(res) {
          ...
          toBeDelete = res.body.result._id;
    ...
    it('should return the updated articles', function(done) {
      request(app)
        ...
        .expect(function(res) {
          ...
          expect(body.result).to.have.key('createdBy');
          expect(body.result).to.have.key('media');
          expect(body.result).to.have.key('title');
          expect(body.result).to.have.key('tags');
          expect(body.result).to.have.key('body');
          expect(body.result).to.have.key('_id');
          expect(body.result).to.have.key('createdAt');
          expect(body.result).to.have.key('modifiedAt');
        })
        .expect(200, done);
    });
  });
