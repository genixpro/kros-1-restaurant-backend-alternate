...
describe('/api/catalogue-categories', function() {
  console.log('Use database: ' + config.mongo.uri);
    ...
    User.find({}).remove(function() {
      User.create({
        ...
        MongoClient.connect(config.mongo.uri, function(err, db) {
          ...
          var catCol = db.collection('cataloguecategories'),
            mediaCol = db.collection('media');

          // Insert some documents
          catCol.insert(dummyCategories, function(err, result) {
  ...
  describe('GET /api/catalogue-categories', function() {
    ...
    it('should respond with JSON array', function(done) {
      request(app)
        ...
        .end(function(err, res) {
          ...
          var body = res.body;
          console.log('Categories: ' + JSON.stringify(body));
  ...
  describe('GET /api/catalogue-categories/:id', function() {

    it('should respond with JSON array', function(done) {
      request(app)
        .get('/api/catalogue-categories/' + firstCategoryId)
        .set('Authorization', getBearer())
        .expect(200)
        .expect('Content-Type', /json/)
        .end(function(err, res) {
